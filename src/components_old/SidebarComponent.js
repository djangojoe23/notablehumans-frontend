...
const SidebarComponent = ({ sidebarOpen, setSidebarOpen, allHumans, selectedListHuman, setSelectedListHuman, setSelectedMarkerHumans }) => {
        ...
        {sidebarOpen && (
          <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto'}}>
              <ListComponent humans={allHumans} itemSize={40} selectedListHuman={selectedListHuman} setSelectedListHuman={setSelectedListHuman} setSelectedMarkerHumans={setSelectedMarkerHumans}/>
            </div>
          </div>
        )}
      </motion.div>
